...
{
    public class DirectingFadeOutIn : DirectingEvent
    {
        ...
        private IEnumerator FadeOutIn(FadeOutInOption fadeOutInOption)
        {
            ...
            // gapEvent
            if (fadeOutInOption.gapEvents != null && fadeOutInOption.gapEvents.Count > 0)
            {
            ...
            if (fadeOutInOption.stringKeys != null && fadeOutInOption.stringKeys.Count > 0)
            {
