...
namespace DirectingEventSystem
{
    ...
    public class ObjectInstantiateCommandSO : DirectingEvent
    {
        ...
        {
            yield return InstantiateObject(objectInstantiateOptions);
        }

        private IEnumerator InstantiateObject(List<ObjectInstantiateOption> objectInstantiateOptions)
        {
            ...
            int index = DirectingEventManager.Instance.GetOptionIndex()[(int)OptionType.ObjectInstantiate];
            ObjectInstantiateOption instantiateOption = objectInstantiateOptions[index];
            DirectingEventManager.Instance.SetOptionIndexValue((int)OptionType.ObjectInstantiate, ++index);
